...
exports.JournalModule = JournalModule = __decorate([
    (0, common_1.Module)({
        imports: [content_module_1.ContentModule, user_module_1.UserModule],
        controllers: [journal_controller_1.JournalController],
        providers: [journal_service_1.JournalService, journal_repository_1.JournalRepository],
        exports: [journal_service_1.JournalService, journal_repository_1.JournalRepository],
    })
], JournalModule);
